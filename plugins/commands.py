...
from info import (ADMINS, AUTH_CHANNEL, BATCH_FILE_CAPTION, CHANNELS, CHNL_LNK,
                  CUSTOM_FILE_CAPTION, GRP_LNK, LOG_CHANNEL, MAX_B_TN, PICS,
                  PROTECT_CONTENT, REQST_CHANNEL, SUPPORT_CHAT_ID)
from Script import script
from utils import (get_settings, get_size, is_subscribed, save_group_settings,
                   temp)
...
async def requests(bot, message):
    ...
    if success:
        ...
        await message.reply_text(
            "<b>Your request has been added! Please wait for some time.</b>",
            reply_markup=InlineKeyboardMarkup(btn),
        )
